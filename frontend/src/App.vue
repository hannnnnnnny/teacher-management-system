...
const fallbackData = {
  ...
  resources: [
    { id: 101, fields: { pc: 'MLC-L2-01', location: 'Main Learning Commons', level: 'Level 2', area: 'East study room', zone: 'Silent study', status: 'available', type: 'Windows desktop', nextChange: 'Bookable now' } },
    { id: 102, fields: { pc: 'MLC-L2-02', location: 'Main Learning Commons', level: 'Level 2', area: 'East study room', zone: 'Silent study', status: 'occupied', type: 'Windows desktop', nextChange: 'Available 2:30 PM' } },
    { id: 103, fields: { pc: 'MLC-L2-03', location: 'Main Learning Commons', level: 'Level 2', area: 'East study room', zone: 'Silent study', status: 'available', type: 'Windows desktop', nextChange: 'Bookable now' } },
    { id: 104, fields: { pc: 'MLC-L2-04', location: 'Main Learning Commons', level: 'Level 2', area: 'East study room', zone: 'Silent study', status: 'maintenance', type: 'Windows desktop', nextChange: 'Service desk check' } },
    { id: 105, fields: { pc: 'MLC-L2-05', location: 'Main Learning Commons', level: 'Level 2', area: 'East study room', zone: 'Silent study', status: 'available', type: 'Dual monitor', nextChange: 'Bookable now' } },
    { id: 106, fields: { pc: 'MLC-L2-06', location: 'Main Learning Commons', level: 'Level 2', area: 'East study room', zone: 'Silent study', status: 'reserved', type: 'Dual monitor', nextChange: 'Reserved until 3:00 PM' } },
    { id: 107, fields: { pc: 'MLC-L3-01', location: 'Main Learning Commons', level: 'Level 3', area: 'North study room', zone: 'Quiet study', status: 'available', type: 'Windows desktop', nextChange: 'Bookable now' } },
    { id: 108, fields: { pc: 'MLC-L3-02', location: 'Main Learning Commons', level: 'Level 3', area: 'North study room', zone: 'Quiet study', status: 'available', type: 'Windows desktop', nextChange: 'Bookable now' } },
    { id: 109, fields: { pc: 'MLC-L3-03', location: 'Main Learning Commons', level: 'Level 3', area: 'North study room', zone: 'Quiet study', status: 'occupied', type: 'Windows desktop', nextChange: 'Available 4:00 PM' } },
    { id: 110, fields: { pc: 'MLC-L3-04', location: 'Main Learning Commons', level: 'Level 3', area: 'North study room', zone: 'Quiet study', status: 'available', type: 'Dual monitor', nextChange: 'Bookable now' } },
    { id: 111, fields: { pc: 'CLC-L1-01', location: 'Central Learning Centre', level: 'Level 1', area: 'Learning commons', zone: 'Individual study', status: 'occupied', type: 'Windows desktop', nextChange: 'Available 1:45 PM' } },
    { id: 112, fields: { pc: 'CLC-L1-02', location: 'Central Learning Centre', level: 'Level 1', area: 'Learning commons', zone: 'Individual study', status: 'available', type: 'Windows desktop', nextChange: 'Bookable now' } },
    { id: 113, fields: { pc: 'CLC-L1-03', location: 'Central Learning Centre', level: 'Level 1', area: 'Learning commons', zone: 'Individual study', status: 'available', type: 'Windows desktop', nextChange: 'Bookable now' } },
    { id: 114, fields: { pc: 'CLC-L1-04', location: 'Central Learning Centre', level: 'Level 1', area: 'Learning commons', zone: 'Individual study', status: 'offline', type: 'Windows desktop', nextChange: 'Network issue' } },
    { id: 115, fields: { pc: 'CLC-L2-01', location: 'Central Learning Centre', level: 'Level 2', area: 'South study room', zone: 'Postgraduate study', status: 'available', type: 'Dual monitor', nextChange: 'Bookable now' } },
    { id: 116, fields: { pc: 'CLC-L2-02', location: 'Central Learning Centre', level: 'Level 2', area: 'South study room', zone: 'Postgraduate study', status: 'reserved', type: 'Dual monitor', nextChange: 'Reserved until 2:00 PM' } },
    { id: 117, fields: { pc: 'CLC-L2-03', location: 'Central Learning Centre', level: 'Level 2', area: 'South study room', zone: 'Postgraduate study', status: 'available', type: 'Windows desktop', nextChange: 'Bookable now' } },
    { id: 118, fields: { pc: 'BTL-L2-01', location: 'Business Technology Lab', level: 'Level 2', area: 'Computer lab 240A', zone: 'Business study', status: 'occupied', type: 'Finance workstation', nextChange: 'Available 3:15 PM' } },
    { id: 119, fields: { pc: 'BTL-L2-02', location: 'Business Technology Lab', level: 'Level 2', area: 'Computer lab 240A', zone: 'Business study', status: 'available', type: 'Finance workstation', nextChange: 'Bookable now' } },
    { id: 120, fields: { pc: 'BTL-L2-03', location: 'Business Technology Lab', level: 'Level 2', area: 'Computer lab 240A', zone: 'Business study', status: 'available', type: 'Finance workstation', nextChange: 'Bookable now' } },
    { id: 121, fields: { pc: 'EDL-L3-01', location: 'Engineering Design Lab', level: 'Level 3', area: 'Collaboration room', zone: 'Project work', status: 'available', type: 'CAD workstation', nextChange: 'Bookable now' } },
    { id: 122, fields: { pc: 'EDL-L3-02', location: 'Engineering Design Lab', level: 'Level 3', area: 'Collaboration room', zone: 'Project work', status: 'maintenance', type: 'CAD workstation', nextChange: 'Software update' } },
    { id: 123, fields: { pc: 'EDL-L3-03', location: 'Engineering Design Lab', level: 'Level 3', area: 'Collaboration room', zone: 'Project work', status: 'available', type: 'CAD workstation', nextChange: 'Bookable now' } },
    { id: 124, fields: { pc: 'EDL-L3-04', location: 'Engineering Design Lab', level: 'Level 3', area: 'Collaboration room', zone: 'Project work', status: 'occupied', type: 'CAD workstation', nextChange: 'Available 5:00 PM' } }
  ]
}
